...
document.querySelector('#postForm').addEventListener('submit', e => {
  ...
  async function createPost() {
    ...
    document.querySelector('#allPostsWraper').innerHTML = `<div class="single-post" data-post_id ="${post.id}">
...
const commentPostSubmit = e => {
  ...
  main_post_el.querySelector('.post-comments').innerHTML += `<div class="single-comment">${current_user.username}: ${comment_value}</div>`;
